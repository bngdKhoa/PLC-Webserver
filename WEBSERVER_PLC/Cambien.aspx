<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cambien.aspx.cs" Inherits="_Default" %>
...
<script>
    ...
    <form id="form1" runat="server">
        ...
        <b>TẤT CẢ GIÁ TRỊ CẢM BIẾN</b>
        </div><br />

        <div>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server"> <%--cập nhật dữ liệu mà k phải load lại toàn bộ page--%>
            <ContentTemplate>
                <asp:Literal ID="Literal1" runat="server"></asp:Literal> <%--dùng để hiện thị dữ liệu từ code-behind--%>
